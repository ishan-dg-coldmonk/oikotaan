    ...
    public void sendRegistrationEmail(String recipientEmail, String regId, String bandName) {
        try {
            ...
            String htmlContent = "<html>"
                    ...
                    + "</ul>"
                    + "<p style='font-size: 16px;'>We look forward to seeing you rock the stage and create magic!</p>"
                    + "<h3 style='color: #333; font-size: 18px;'>Contact Us:</h3>"
                    + "<table style='width: auto; font-size: 15px; line-height: 1.8; margin-top: 10px;'>"
